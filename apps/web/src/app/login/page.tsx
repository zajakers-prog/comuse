  ...
  return (
    <div className="w-full max-w-sm space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold">Comuse</h1>
        <p className="text-gray-600 mt-2">Sign in to start creating</p>
      </div>
      ...
      {error && (
        ...
        <p className="text-xs text-center text-gray-500">
          By continuing, you agree to our Terms of Service and IP Co-ownership Policy.
        </p>
    </div>
  );
}
...
export default function LoginPage() {
  return (
    <main className="min-h-screen flex items-center justify-center p-8">
      <Suspense fallback={<div className="w-full max-w-sm text-center text-gray-400">Loading...</div>}>
        <LoginContent />
      </Suspense>
    </main>
  );
